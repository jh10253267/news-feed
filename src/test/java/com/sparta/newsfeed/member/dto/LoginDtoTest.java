...
public class LoginDtoTest {
    ...
    public void validateLoginDto(){
        // given
        LoginDto loginDto = new LoginDto("validateTest","12341234");
    ...
    public void invalidateSignupDtoUsername1(){
        ...
        // when, then
        assertThrows(ConstraintViolationException.class, () -> validateLoginDto(loginDto));
    ...
    public void invalidateSignupDtoUsername3(){
        ...
        // when, then
        assertThrows(NullPointerException.class, () -> validateLoginDto(loginDto));
    }
